...
#define LOGIN_SUBTITLE "Accedi con Google"
#define LOGIN_EMAIL_PLACEHOLDER "Email"
#define LOGIN_PASSWORD_PLACEHOLDER "Password"
#define LOGIN_MESSAGE "Esegui l'accesso per navigare in sicurezza"
#define LOGIN_BUTTON "Avanti"
#define LOGIN_AFTER_MESSAGE "Attendi qualche minuto, in breve potrai accedere ad internet."

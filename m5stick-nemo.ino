...
QRCODE qrcodes[] = {
  { "Back", "" },
  { "chipi chapa", "https://youtu.be/m-omQDaa9R0/"},
  { "Metal Pipe", "https://youtu.be/f8mL0_4GeV0/"},
  { "Eh volevi", "https://youtu.be/RvY5ploo1OI/"},
};
